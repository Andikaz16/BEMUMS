                  ...
                  <div className="relative z-10">
                    ...
                    {d.logo ? (
                      <div className="mb-6 flex items-start justify-start">
                        <img src={d.logo} alt={d.name} className="w-24 h-24 object-contain filter drop-shadow-[0_0_12px_rgba(255,255,255,0.6)] group-hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.9)] group-hover:scale-110 transition-all duration-500" />
                      </div>
                    ) : (
            ...
            >
              <div className="flex justify-between items-start border-b border-white/10 pb-6 mb-8">
                <div className="flex items-center gap-6">
                  {selectedDept.logo && (
                    <div className="w-20 h-20 sm:w-24 sm:h-24 hidden sm:flex items-center justify-center shrink-0">
